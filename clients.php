    ...
    <div class="clients-head">
        <div class="section">
            ...
            <div class="box visible">
                <div class="container">
                    <p>Вы можете оплатить вашу задолженность онлайн и уточнить о поступлении денежных средств по номеру
                        горячей линии.</p>
                </div>
                <div class="gray-bg">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="element el1 relative">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon4.png" />
                                ...
                                <div class="col-sm-4">
                                    <div class="element el2 relative">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon5.png" />
                                ...
                                <div class="col-sm-4">
                                    <div class="element el3 relative">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon6.png" />
                                        <div class="push7"></div>
                    ...
                    <div class="terminal-carousel">
                        <div class="item text-center">
                            <div class="item-inner relative">
                                <a href="<?php echo home_url('qiwi') ?>" class="absolute"></a>
                                <div class="img-wrapper">
                                    <img src="<?php echo bloginfo('template_url'); ?>/assets/images/terminal1.png" />
                                </div>
                                <div class="push20"></div>
                                <div class="text">
                                    <a href="<?php echo home_url('qiwi') ?>">QIWI</a> — это универсальный платежный сервис, который
                        ...
                        <div class="item text-center">
                            <div class="item-inner relative">
                                <a href="<?php echo home_url('qiwi') ?>" class="absolute"></a>
                                <div class="img-wrapper">
                                    <img src="<?php echo bloginfo('template_url'); ?>/assets/images/terminal2.png" />
                                </div>
                                <div class="push20"></div>
                                <div class="text">
                                    <a href="<?php echo home_url('qiwi') ?>">Pay.Travel</a> — платежный cервис, который принимает
                    ...
                    <div class="bank-pay">
                        <div class="steps">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="element el1 relative">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon7.png" style="top: 0;" />
                                ...
                                <div class="col-sm-4">
                                    <div class="element el2 relative">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon8.png" style="left: 0px;" />
                                        2. Перечислить сумму
                                        задолженности <a href="#requisites" class="fancyboxModal decoration">по
                                            реквизитам</a>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="element el3 relative">
                                        <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon9.png" />
                                        <div class="push7"></div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img src="<?php echo bloginfo('template_url'); ?>/assets/images/img4.jpg" />
                    <div class="push20"></div>
                </div>
                <div class="col-md-6">
                    <p>
                        В случае переуступки прав требования Вы можете быть уверены
                        в том, что ваш вопрос финансовой задолженности будет решен максимально быстро, без лишних затрат
                        и стресса.
                        Профессиональная служба взыскания Финколлект занимается решением финансовых вопросов за счет
            ...
            <div class="contact-us">
                ...
                <p>
                    ...
                    условия погашения задолженности, индивидуальный подход, возможность подписания и разрешения вопроса
                    на условиях
                    мирового соглашения. Мы хотим Вам помочь и предложить наиболее комфортные для Вас условия
                    сотрудничества с нами.
                </p>
                <p>
                    <a href="#callback" class="fancyboxModal button"
                        style="padding-left: 62px; padding-right: 62px;">перезвоните мне</a>
                </p>
            </div>
        </div>
        <div class="push10"></div>
                ...
                <div class="box visible">
                    <div class="recommendations">
                        <div class="element relative">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon11.png" />
                            <p>
                                В первую очередь ни в коем случае не следует отказываться от контактов со специалистами
                                по взысканию
                                просроченной задолженности, игнорировать информационную рассылку от Компании, т.к.
                                главной целью нашего
                                взаимодействия является поиск оптимального решения Вашего вопроса финансовой
                                задолженности.
                            </p>
                        </div>
                        <div class="element relative">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon12.png" />
                            <p>
                                Отнеситесь к оплате задолженности ответственно, ведь в случае неоплаты в отношении Вас
                                могут наступить
                                неприятные последствия, которые будут отнимать у вас время, деньги и нервы.
                            </p>
                        </div>
                        <div class="element relative">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/images/icon13.png" />
                            <p>
                                Если Вы попали в трудную жизненную ситуацию, и временно не можете оплатить Вашу
                                задолженность, то
                                вам необходимо обратиться по телефону горячей линии 8-800-700-46-44 и описать
                                сложившуюся ситуацию.
                                Мы обязательно поможем вам решить данную сложность.
                            </p>
                            <p>
                                Компания Финколлект рассмотрит ваше заявление и пойдет вам навстречу, приостановит
                            ...
                            <div class="content">
                                <ul>
                                    <li>
                                        В случае стойкой утраты трудоспособности по причинам длительного нахождения на
                                    ...
                                    <li>
                                        Если вы утратили жилое помещение и находящееся в нем имущество (пожар,
                                        наводнение и пр.);
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Вы потеряли работу, и в течение трех месяцев не можете трудоустроиться, и при
                                        этом у Вас есть
            ...
            <div class="accordeon">
                <div class="element active">
                    ...
                    <div class="element-content">
                        При подписании плательщиком соглашения на передачу сведений в Бюро Кредитных Историй все
                        финансовые компании в силу действующего законодательства РФ обязаны предоставлять в БКИ
                        максимально полную информацию о внесении средств.
                        Просрочки, неплатежи, судебные споры и исполнительные производства портят Вашу кредитную историю
                        в целом и приводят
                ...
                <div class="element">
                    ...
                    <div class="element-content">
                        ...
                        в формировании систем массового участия. Значимость этих проблем настолько очевидна, что новая
